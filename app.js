...
const produtos = [
  ...
  {id: 2, nome: "Good Girl: Velvet Fatale", preco:"549,90", marca:"Carolina Herrera", descricao: "Notas: As notas de topo são: Amêndoa, Café, Limão e Bergamota. As notas de coração são: Tuberosa, Jasmim, Rosa Búlgara e Raíz de Orris.", imagem:"goodgirl.jpg"}, 
  ...
  {id: 6, nome: "Scandal Intense", preco:"628,00", marca:" Jean Paul Gaultier", descricao: "Notas: Cereja negra, Amendoa amarga, Rosa absoluta, Tonka Torrada.", imagem:"Scandal-Le-Parfum-Feminino-02.jpg"},
